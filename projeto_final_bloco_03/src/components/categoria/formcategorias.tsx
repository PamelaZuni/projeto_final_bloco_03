    ...
    <div className="flex flex-col items-center justify-center h-full bg-cyan-200">
      ...
      <form className="w-1/2 flex flex-col gap-4" onSubmit={gerarNovaCategoria}>
        <div className="flex flex-col gap-2 ">
          <input type="text" placeholder="Categoria" name="nome" className="border-2 border-slate-700 rounded p-2 utral-800" required value={categoria.nome} onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)} />
        </div>
        <button
